	...
	*/
	...
	$schema = array(
		'customers' => array(
			...
			'CompanyName' => array('appgini' => 'VARCHAR(40) null '),
			'ContactName' => array('appgini' => 'VARCHAR(30) null '),
			'ContactTitle' => array('appgini' => 'VARCHAR(30) null '),
			'Address' => array('appgini' => 'TEXT null '),
			'City' => array('appgini' => 'VARCHAR(15) null '),
			'Region' => array('appgini' => 'VARCHAR(15) null '),
			'PostalCode' => array('appgini' => 'VARCHAR(10) null '),
			'Country' => array('appgini' => 'VARCHAR(15) null '),
			'Phone' => array('appgini' => 'VARCHAR(24) null '),
			'Fax' => array('appgini' => 'VARCHAR(24) null '),
			'TotalSales' => array('appgini' => 'DOUBLE(10,2) null '),
		),
		'employees' => array(
			'EmployeeID' => array('appgini' => 'INT not null primary key auto_increment '),
			'TitleOfCourtesy' => array('appgini' => 'VARCHAR(50) null '),
			'Photo' => array('appgini' => 'VARCHAR(40) null '),
			'LastName' => array('appgini' => 'VARCHAR(50) null '),
			'FirstName' => array('appgini' => 'VARCHAR(10) null '),
			'Title' => array('appgini' => 'VARCHAR(30) null '),
			'BirthDate' => array('appgini' => 'DATE null '),
			'Age' => array('appgini' => 'INT null '),
			'HireDate' => array('appgini' => 'DATE null '),
			'Address' => array('appgini' => 'VARCHAR(50) null '),
			'City' => array('appgini' => 'VARCHAR(15) null '),
			'Region' => array('appgini' => 'VARCHAR(15) null '),
			'PostalCode' => array('appgini' => 'VARCHAR(10) null '),
			'Country' => array('appgini' => 'VARCHAR(15) null '),
			'HomePhone' => array('appgini' => 'VARCHAR(24) null '),
			'Extension' => array('appgini' => 'VARCHAR(4) null '),
			'Notes' => array('appgini' => 'TEXT null '),
			'ReportsTo' => array('appgini' => 'INT null '),
			'TotalSales' => array('appgini' => 'DOUBLE(10,2) null '),
		),
		'orders' => array(
			'OrderID' => array('appgini' => 'INT not null primary key auto_increment '),
			'status' => array('appgini' => 'VARCHAR(200) null '),
			'CustomerID' => array('appgini' => 'VARCHAR(5) null '),
			'EmployeeID' => array('appgini' => 'INT null '),
			'OrderDate' => array('appgini' => 'DATE null '),
			'RequiredDate' => array('appgini' => 'DATE null '),
			'ShippedDate' => array('appgini' => 'DATE null '),
			'ShipVia' => array('appgini' => 'INT(11) null '),
			'Freight' => array('appgini' => 'FLOAT(10,2) null default \'0\' '),
			'ShipName' => array('appgini' => 'VARCHAR(5) null '),
			'ShipAddress' => array('appgini' => 'VARCHAR(5) null '),
			'ShipCity' => array('appgini' => 'VARCHAR(5) null '),
			'ShipRegion' => array('appgini' => 'VARCHAR(5) null '),
			'ShipPostalCode' => array('appgini' => 'VARCHAR(5) null '),
			'ShipCountry' => array('appgini' => 'VARCHAR(5) null '),
			'total' => array('appgini' => 'DECIMAL(10,2) null '),
		),
		'order_details' => array(
			'odID' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'OrderID' => array('appgini' => 'INT null default \'0\' '),
			'ProductID' => array('appgini' => 'INT null default \'0\' '),
			'Category' => array('appgini' => 'INT null '),
			'CatalogPrice' => array('appgini' => 'INT null '),
			'UnitsInStock' => array('appgini' => 'INT null '),
			'UnitPrice' => array('appgini' => 'FLOAT(10,2) null default \'0\' '),
			'Quantity' => array('appgini' => 'SMALLINT null default \'1\' '),
			'Discount' => array('appgini' => 'FLOAT(10,2) null default \'0\' '),
			'Subtotal' => array('appgini' => 'DOUBLE(10,2) null '),
		),
		'products' => array(
			'ProductID' => array('appgini' => 'INT not null primary key auto_increment '),
			'ProductName' => array('appgini' => 'VARCHAR(50) null '),
			'SupplierID' => array('appgini' => 'INT(11) null '),
			'CategoryID' => array('appgini' => 'INT null '),
			'QuantityPerUnit' => array('appgini' => 'VARCHAR(50) null '),
			'UnitPrice' => array('appgini' => 'FLOAT(10,2) null default \'0\' '),
			'UnitsInStock' => array('appgini' => 'SMALLINT null default \'0\' '),
			'UnitsOnOrder' => array('appgini' => 'SMALLINT(6) null default \'0\' '),
			'ReorderLevel' => array('appgini' => 'SMALLINT null default \'0\' '),
			'Discontinued' => array('appgini' => 'TINYINT null default \'0\' '),
		),
		'categories' => array(
			'CategoryID' => array('appgini' => 'INT not null primary key auto_increment '),
			'Picture' => array('appgini' => 'VARCHAR(40) null '),
			'CategoryName' => array('appgini' => 'VARCHAR(50) null unique '),
			'Description' => array('appgini' => 'TEXT null '),
		),
		'suppliers' => array(
			'SupplierID' => array('appgini' => 'INT(11) not null primary key auto_increment '),
			'CompanyName' => array('appgini' => 'VARCHAR(50) null '),
			'ContactName' => array('appgini' => 'VARCHAR(30) null '),
			'ContactTitle' => array('appgini' => 'VARCHAR(30) null '),
			'Address' => array('appgini' => 'VARCHAR(50) null '),
			'City' => array('appgini' => 'VARCHAR(15) null '),
			'Region' => array('appgini' => 'VARCHAR(15) null '),
			'PostalCode' => array('appgini' => 'VARCHAR(10) null '),
			'Country' => array('appgini' => 'VARCHAR(50) null '),
			'Phone' => array('appgini' => 'VARCHAR(24) null '),
			'Fax' => array('appgini' => 'VARCHAR(24) null '),
			'HomePage' => array('appgini' => 'TEXT null '),
		),
		'shippers' => array(
