...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->ColWidth   = array(  90, 250, 200, 150, 100, 50, 120, 150);
	$x->ColCaption = array("Customer ID", "Company Name", "Contact Name", "Address", "City", "Region", "Country", "Total Sales");
	$x->ColFieldName = array('CustomerID', 'CompanyName', 'ContactName', 'Address', 'City', 'Region', 'Country', 'TotalSales');
	$x->ColNumber  = array(1, 2, 3, 5, 6, 7, 9, 12);
