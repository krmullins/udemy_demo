...
function order_details_insert() {
	...
	$data['Category'] = $_REQUEST['ProductID'];
		if($data['Category'] == empty_lookup_value) { $data['Category'] = ''; }
	$data['CatalogPrice'] = $_REQUEST['ProductID'];
		if($data['CatalogPrice'] == empty_lookup_value) { $data['CatalogPrice'] = ''; }
	$data['UnitsInStock'] = $_REQUEST['ProductID'];
		if($data['UnitsInStock'] == empty_lookup_value) { $data['UnitsInStock'] = ''; }
	$data['UnitPrice'] = $_REQUEST['UnitPrice'];
	...
	if(!empty($_REQUEST['SelectedID'])) order_details_copy_children($recID, $_REQUEST['SelectedID']);
...
function order_details_update($selected_id) {
	...
	$data['Category'] = makeSafe($_REQUEST['ProductID']);
		if($data['Category'] == empty_lookup_value) { $data['Category'] = ''; }
	$data['CatalogPrice'] = makeSafe($_REQUEST['ProductID']);
		if($data['CatalogPrice'] == empty_lookup_value) { $data['CatalogPrice'] = ''; }
	$data['UnitsInStock'] = makeSafe($_REQUEST['ProductID']);
		if($data['UnitsInStock'] == empty_lookup_value) { $data['UnitsInStock'] = ''; }
	...
	sql('update `order_details` set       `OrderID`=' . (($data['OrderID'] !== '' && $data['OrderID'] !== NULL) ? "'{$data['OrderID']}'" : 'NULL') . ', `ProductID`=' . (($data['ProductID'] !== '' && $data['ProductID'] !== NULL) ? "'{$data['ProductID']}'" : 'NULL') . ', `Category`=' . (($data['Category'] !== '' && $data['Category'] !== NULL) ? "'{$data['Category']}'" : 'NULL') . ', `CatalogPrice`=' . (($data['CatalogPrice'] !== '' && $data['CatalogPrice'] !== NULL) ? "'{$data['CatalogPrice']}'" : 'NULL') . ', `UnitsInStock`=' . (($data['UnitsInStock'] !== '' && $data['UnitsInStock'] !== NULL) ? "'{$data['UnitsInStock']}'" : 'NULL') . ', `UnitPrice`=' . (($data['UnitPrice'] !== '' && $data['UnitPrice'] !== NULL) ? "'{$data['UnitPrice']}'" : 'NULL') . ', `Quantity`=' . (($data['Quantity'] !== '' && $data['Quantity'] !== NULL) ? "'{$data['Quantity']}'" : 'NULL') . ', `Discount`=' . (($data['Discount'] !== '' && $data['Discount'] !== NULL) ? "'{$data['Discount']}'" : 'NULL') . " where `odID`='".makeSafe($selected_id)."'", $o);
	if($o['error']!='') {
		echo $o['error'];
...
function order_details_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = '') {
	...
	if($dvprint) {
		...
		$templateCode .= "\t\t\tcontentType: 'application/x-www-form-urlencoded; charset=" . datalist_db_encoding . "',\n";
		$templateCode .= "\t\t\ttype: 'GET',\n";
		$templateCode .= "\t\t\tbeforeSend: function() { \$j('#ProductID$rnd1').prop('disabled', true); \$j('#ProductIDLoading').html('<img src=loading.gif align=top>'); },\n";
		$templateCode .= "\t\t\tcomplete: function() { " . (($arrPerm[1] || (($arrPerm[3] == 1 && $ownerMemberID == getLoggedMemberID()) || ($arrPerm[3] == 2 && $ownerGroupID == getLoggedGroupID()) || $arrPerm[3] == 3)) ? "\$j('#ProductID$rnd1').prop('disabled', false); " : "\$j('#ProductID$rnd1').prop('disabled', true); ")."\$j('#ProductIDLoading').html(''); \$j(window).resize(); }\n";
	}
	$templateCode .= "\t\t});\n";
	$templateCode .= "\t};\n";
